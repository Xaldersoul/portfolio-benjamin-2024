...
interface ProjectPostDocumentData {
   ...
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: project_post.repo_link
   * - **Tab**: Main
...
export interface ContentIndexSliceDefaultPrimary {
   ...
   */
  content_type: prismic.SelectField<"Blog" | "Proyect">;
...
export interface ExperienceSliceDefaultItem {
  ...
  /**
   * Diploma Link field in *Experience → Items*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.items[].diploma_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  diploma_link: prismic.LinkField;
}
